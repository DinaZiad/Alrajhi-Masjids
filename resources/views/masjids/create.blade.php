...
<div class="masjids-page-container" style="max-width:1200px;margin:0 auto;">
    <div class="masjids-table-card" style="background:#faf9f6;border-radius:16px;box-shadow:0 4px 24px rgba(30,41,59,0.07);padding:2.2rem 1.5rem;border-top:5px solid #d4af37;">
        ...
        <form method="POST" action="{{ route('masjids.store') }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">المساحة المغطاة بالمتر المربع <span class="text-danger">*</span></label>
                    <div class="input-icon-wrapper">
                        <i class="fas fa-ruler-combined input-inside-icon"></i>
                        <input type="number" step="0.01" name="covered_area_sqm" class="form-control" value="{{ old('covered_area_sqm') }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;" required>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
